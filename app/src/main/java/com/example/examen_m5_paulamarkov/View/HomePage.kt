...
class HomePage : Fragment() {
    ...
    override fun onCreateView(
        ...
        hpBinding.btnEnvia.setOnClickListener {
            it.findNavController().navigate(R.id.action_homePage2_to_sendMoney)
        }

        hpBinding.btnIngresa.setOnClickListener {
            it.findNavController().navigate(R.id.action_homePage2_to_requestMoney)
        }

        hpBinding.imgProfile.setOnClickListener {
            it.findNavController().navigate(R.id.action_homePage2_to_profilePage)
        }
